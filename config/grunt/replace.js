        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: () => grunt.file.expand({ cwd: 'build/web-audio-conference-2018' }, 'assets/*.apple-touch-icon.png')[0]
                }, {
                    match: /assets\/favicon\.ico/g,
                    replacement: () => grunt.file.expand({ cwd: 'build/web-audio-conference-2018' }, 'assets/*.favicon.ico')[0]
                }, {
                    ...
                    match: /"\/web-audio-conference-2018\/index\.html":\s"[a-z0-9]+"/g,
                    replacement: () => {
                        return `"/web-audio-conference-2018/index.html": "${ computeHashOfFile('build/web-audio-conference-2018/index.html', 'sha1', 'hex') }"`;
                    }
                } ]
            }
        },
