...
@Component({
    ...
    styleUrls: [ './slide-fifteen.component.css' ],
    templateUrl: './slide-fifteen.component.html'
})
export class SlideFifteenComponent implements OnInit {
    ...
    public ngOnInit () {
        ...
        this.disneylandAttempts$ = this.gameClock$
            .pipe(
                map((value) => (value >= THIRTY_EIGHT_MINUTES_IN_MILLISECONDS) ?
                    4 :
        ...
        this.legolandAttempts$ = this.gameClock$
            .pipe(
                map((value) => (value >= TWENTY_FIVE_MINUTES_IN_MILLISECONDS) ?
                    9 :
        ...
        this.legolandScore$ = this.gameClock$
            .pipe(
                map((value) => (value >= TWENTY_FIVE_MINUTES_IN_MILLISECONDS) ?
                    2 :
                    (value >= TWENTY_MINUTES_IN_MILLISECONDS) ?
