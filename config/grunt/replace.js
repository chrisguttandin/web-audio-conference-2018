...
module.exports = (grunt) => {
    return {
        ...
        'csp-production': {
            files: {
                'build/web-audio-conference-2018/index.html': ['build/web-audio-conference-2018/index.html']
            },
            options: {
                patterns: [
                    {
                ...
                patterns: [
                    {
                        ...
                        replacement: (_, filename, extension) =>
                            grunt.file.expand({ cwd: 'build/web-audio-conference-2018', ext: extension }, `assets/${filename}.*`)[0]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/web-audio-conference-2018${filename}": "${computeHashOfFile(
                                `build/web-audio-conference-2018${filename}`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/web-audio-conference-2018/${filename}.html": "${computeHashOfFile(
                                `build/web-audio-conference-2018/${filename}.html`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
                ...
                patterns: [
                    {
                        ...
                        replacement: (match, filename) => {
                            const hash = `sha384-${computeHashOfFile(
                                `build/web-audio-conference-2018/styles/${filename}`,
                                'sha384',
                                'base64'
                            )}`;
