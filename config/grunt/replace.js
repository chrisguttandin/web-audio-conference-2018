...
module.exports = (grunt) => {
    return {
        'csp-production': {
            files: {
                './': ['build/web-audio-conference-2018/browser/**/index.html']
            },
            options: {
                patterns: [
                    {
        ...
        'manifest': {
            files: {
                './': ['build/web-audio-conference-2018/browser/ngsw.json']
            },
            options: {
                patterns: [
                    {
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/web-audio-conference-2018/browser/${filename}.html": "${computeHashOfFile(
                                `build/web-audio-conference-2018/browser/${filename}.html`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
