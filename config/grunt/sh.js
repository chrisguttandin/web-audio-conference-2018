...
module.exports = {
    ...
    lint: {
        cmd: `htmlhint --rules ${ convertConfig(documentConfig) } 'src/**/index.html' && htmlhint --rules ${ convertConfig(templateConfig) } 'src/app/**/*.component.html' && ng lint web-audio-conference-2018 --type-check && ng lint web-audio-conference-2018 --configuration test`
    },
    monitor: {
        cmd: 'ng serve --aot'
    },
